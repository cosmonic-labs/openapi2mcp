...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./openapi2mcp.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./openapi2mcp.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'wasi:io/error@0.2.4': {
        '[method]error.to-debug-string': exports0['18'],
      ...
      'wasi:sockets/udp@0.2.0': {
        ...
        '[resource-drop]outgoing-datagram-stream': trampoline8,
        '[resource-drop]udp-socket': trampoline6,
      },
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:filesystem/preopens@0.2.6': {
        'get-directories': exports0['40'],
      },
      'wasi:filesystem/types@0.2.6': {
        '[method]descriptor.append-via-stream': exports0['29'],
        ...
        '[method]descriptor.open-at': exports0['25'],
        '[method]descriptor.read-directory': exports0['22'],
        '[method]descriptor.read-via-stream': exports0['27'],
        '[method]descriptor.stat': exports0['31'],
        '[method]descriptor.stat-at': exports0['24'],
        '[method]descriptor.unlink-file-at': exports0['26'],
        '[method]descriptor.write-via-stream': exports0['28'],
        '[method]directory-entry-stream.read-directory-entry': exports0['23'],
      ...
      'wasi:io/streams@0.2.6': {
        ...
        '[method]output-stream.blocking-write-and-flush': exports0['39'],
        '[method]output-stream.check-write': exports0['36'],
        '[method]output-stream.write': exports0['37'],
        '[resource-drop]input-stream': trampoline5,
        '[resource-drop]output-stream': trampoline0,
      },
    }));
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '0': trampoline16,
        '1': exports2.path_unlink_file,
        '10': exports2.fd_close,
        '11': exports2.fd_fdstat_get,
...
export { run026 as run, run026 as 'wasi:cli/run@0.2.6',  }